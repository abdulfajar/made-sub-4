...
public class FavoritTvAdapter extends RecyclerView.Adapter<FavoritTvAdapter.ViewHolder> {
    ...
    public FavoritTvAdapter(Context context){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final FavoritTv favorite = getItem(position);
        Glide.with(context)
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(DetailActivity.EXTRA_NAME, 4);
    ...
    private FavoritTv getItem(int position){
        if (!listFavorite.moveToPosition(position)) {
            throw new IllegalStateException("Position invalid");
        }
        return new FavoritTv(listFavorite);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            rv_list = itemView.findViewById(R.id.rv_fav_tv);
        }
    }
